#coding:utf-8
'''
@Time: 2019/8/13 下午1:46
@author: Tokyo
@file: tk_36_testModel_hfj162.py
@desc:最后选定测试故障数据:hfj162
'''
...
df1_t = pd.read_csv('./data/B/hfj162_test/test data.csv')
df1_t = df1_t.dropna()
...
plt.hlines(y=75, xmin=0, xmax=10000, colors='r', label='Upper Limit')
