...
x_labels = ax1.set_xticklabels(["July/01", "July/06", "July/11", "July/15", "July/20", "July/25",  "July/29"],
...
x_labels = ax2.set_xticklabels(["July/01", "July/06", "July/11", "July/15", "July/20", "July/25",  "July/29"],
                               rotation=30, fontsize="small")
...
x_labels = ax3.set_xticklabels(["July/01", "July/06", "July/11", "July/15", "July/20", "July/25",  "July/29"],
                               rotation=30, fontsize="small")

plt.ylabel('CUSUM chart')
plt.xlabel('Date')
plt.savefig('./data/figure/test normalA.png', dpi=300)
plt.show() 