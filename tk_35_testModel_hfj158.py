#coding:utf-8
'''
@Time: 2019/8/13 下午1:20
@author: Tokyo
@file: tk_35_testModel_hfj158.py
@desc:
'''
...
df1_t = pd.read_csv('./data/B/hfj158_test/test data.csv')
df1_t = df1_t.dropna()
...
plt.hlines(y=80, xmin=0, xmax=10000, colors='r', label='Upper Limit')
